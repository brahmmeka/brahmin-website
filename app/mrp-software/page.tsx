...
const buyerQuestions = [
  ...
  },
  {
    ...
    guidance:
      'Native integration with QuickBooks or Xero is table stakes. The sync should handle purchase orders, sales orders, invoices, and inventory values automatically — in both directions. If accounting sync requires Zapier or a third-party connector, that\'s a yellow flag for reliability and data accuracy.',
  },
  {
