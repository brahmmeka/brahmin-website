        ...
        <div className="relative container mx-auto px-6 max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-slate-900 tracking-tight leading-[1.08]">
              MRP software built for how you actually manufacture
            </h1>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <blockquote className="text-xl text-white font-medium leading-relaxed">
                  &ldquo;We went live in 18 days. Our previous ERP implementation took 8 months and we still had to hire a consultant.&rdquo;
                </blockquote>
                <div className="mt-6 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-slate-700 flex items-center justify-center text-slate-300 font-bold text-sm">JL</div>
                  <div>
                    <div className="text-white font-semibold text-sm">Jason L.</div>
                    <div className="text-slate-400 text-xs">Plant Manager, Summit Manufacturing</div>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { n: '18 days', l: 'To go live' },
                  { n: '40%', l: 'Labor cost reduction' },
                  { n: '99.8%', l: 'Inventory accuracy' },
                  { n: '2×', l: 'Production throughput' },
                ].map((s) => (
