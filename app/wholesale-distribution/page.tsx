...
const features = [
  ...
  },
  {
    ...
    description: 'Keep Shopify, WooCommerce, and Amazon inventory in sync automatically. Overselling eliminated.',
        ...
        <div className="relative container mx-auto px-6 max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-slate-900 tracking-tight leading-[1.08]">
              Wholesale distribution software that lets customers order 24/7
            </h1>
            ...
            <div className="bg-accent-50 border border-accent-100 rounded-3xl p-10">
              <div className="text-center">
                ...
                <blockquote className="text-slate-700 text-sm leading-relaxed italic border-l-4 border-accent-200 pl-4 text-left">
                  &ldquo;Our sales team used to spend half their day taking orders by phone. Now they focus on new accounts. Revenue is up 40%.&rdquo;
                </blockquote>
                <div className="mt-4 flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-accent-200 flex items-center justify-center text-accent-700 text-xs font-bold">AP</div>
                  <div className="text-left">
                    <div className="text-sm font-semibold text-slate-900">Ashley Park</div>
                    <div className="text-xs text-slate-500">Head of Sales, Nefaire</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <blockquote className="text-xl text-white font-medium leading-relaxed">
                  &ldquo;We eliminated an entire category of busywork. The team now focuses on actual growth instead of updating spreadsheets.&rdquo;
                </blockquote>
                <div className="mt-6 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-primary-500 flex items-center justify-center text-white font-bold text-sm">MC</div>
                  <div>
                    <div className="text-white font-semibold text-sm">Maria Chen</div>
                    <div className="text-primary-200 text-xs">Operations Manager, Bold Distribution</div>
                  </div>
                </div>
              </div>
