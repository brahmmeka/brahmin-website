      ...
      <div className="relative container mx-auto px-6 max-w-4xl py-24 text-center">
        ...
        >
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/demo"
              className="inline-flex items-center gap-2 bg-accent-500 hover:bg-accent-400 text-white px-6 py-3 md:px-10 md:py-4 rounded-xl font-bold text-lg transition-all shadow-xl shadow-black/20 hover:-translate-y-0.5 active:translate-y-0"
            >
              Book your demo
          ...
          {/* Trust signals */}
          <div className="mt-14 pt-8 border-t border-white/10 flex flex-wrap justify-center gap-4 md:gap-10">
            {[
